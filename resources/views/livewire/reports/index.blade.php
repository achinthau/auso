    ...
    <div class="max-w-7xl mx-auto py-10 px-6 space-y-4">
        <div class="bg-white ">
            ...
            <div class="bg-white rounded-md p-4 grid grid-cols-3 gap-3">
                <a href="{{ route('reports.call-detail') }}"
                    ...
                    <div>
                        <div class="text-lg font-semibold text-gray-700">Call Report </div>
                        <div
                ...
                <a href="{{ route('reports.agent-break-summary-report') }}"
                    ...
                    <div>
                        <div class="text-lg font-semibold text-gray-700">Call Queue </div>
                        <div
                            class="text-sm text-gray-600 font-thin text-ellipsis whitespace-nowrap overflow-hidden w-60 hover:w-full hover:whitespace-normal transition transform">
                            Pending Table Queue Count
                        </div>
                    </div>
                </a>
                <a href="{{ route('reports.agent-break-summary-report') }}"
                    ...
                    <div>
                        <div class="text-lg font-semibold text-gray-700">Agent Call Summary  </div>
                        <div
                            class="text-sm text-gray-600 font-thin text-ellipsis whitespace-nowrap overflow-hidden w-60 hover:w-full hover:whitespace-normal transition transform">
                            Pending
                        </div>
                ...
                <a href="{{ route('reports.agent-break-summary-report') }}"
                    ...
                    <div>
                        <div class="text-lg font-semibold text-gray-700">Daily Queue Summary  </div>
                        <div
                            class="text-sm text-gray-600 font-thin text-ellipsis whitespace-nowrap overflow-hidden w-60 hover:w-full hover:whitespace-normal transition transform">
                            Pending
                        </div>
